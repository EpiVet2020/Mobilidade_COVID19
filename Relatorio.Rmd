...
concelho_distrito <- fread("https://raw.githubusercontent.com/EpiVet2020/Mobilidade_COVID19/main/concelho_distrito.csv?token=AO4UTASVUZNKUWD6MFISBZS7RB4SM") %>% 
...
## **Determinação do Desfasamento Ótimo entre a Taxa de Mobilidade (MR) e a Taxa de Crescimento de Novos Casos (GR)** {.tabset .tabset-fade .tabset-pills}
***
...
<ul>
  <li>Qual o melhor gráfico para MR ao longo do tempo? Média rolante ou tendência?</li>
...
<br>  
  <li>Como o declive é quase 0 signfica que não têm relação?</li>
...
<br>  
  <li>Qual a melhor maneira de fazer a correlação? A primeira é com a correlação de pearson o que dá lag 10 e a segunda é com os coeficientes de glm o que dá lag 17. O que é melhor usar? E com estas correlações tão baixas podemos tirar conclusões do lag e da influencia da mobilidade nos casos?</li>
