...
=======
mobilidade_google <- fread("https://raw.githubusercontent.com/EpiVet2020/Mobilidade_COVID19/main/google_mobilidade_pt.csv?token=AO4UTARD5XLQSQHJU2CCKZ27TFOZ6")
>>>>>>> 1b9c5b07d21e053b9f59b2705d4b11c53b050491
...
No artigo [*The Lancet*](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(20)30553-3/fulltext#sec1) os valores da mobilidade variam entre 0 e >1. O valor 0 indica que não houve movimentações, 0.5 significa que foram feitas metade das movimentações em relação ao padrão, 1 indica que não houve alteração no número de movimentações em relação ao valor de referência e >1 significa que o número de movimentações aumentou. 
